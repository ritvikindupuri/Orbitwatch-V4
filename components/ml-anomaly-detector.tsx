                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p>Anomaly score from the TensorFlow.js model. Higher values indicate stronger anomaly signals.</p>
                                  <p className="mt-1">Range: 0-1, where values closer to 1 indicate higher confidence in the anomaly detection.</p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          </div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Percentage of correctly classified instances (both anomalies and normal data).</p>
                                <p className="mt-1">Formula: (True Positives + True Negatives) / Total Samples</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Percentage of correctly identified anomalies among all instances classified as anomalies.</p>
                                <p className="mt-1">Formula: True Positives / (True Positives + False Positives)</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Percentage of actual anomalies that were correctly identified by the model.</p>
                                <p className="mt-1">Formula: True Positives / (True Positives + False Negatives)</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Harmonic mean of precision and recall, providing a balanced measure of model performance.</p>
                                <p className="mt-1">Formula: 2 * (Precision * Recall) / (Precision + Recall)</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </div>
