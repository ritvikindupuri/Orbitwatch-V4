                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>Confidence level of the prediction model for this specific alert.</p>
                              <p className="mt-1">Based on ensemble learning from multiple predictive models trained on historical satellite anomaly data.</p>
                              <p className="mt-1">Range: 0-100%, where higher values indicate greater confidence in the prediction.</p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </div>
