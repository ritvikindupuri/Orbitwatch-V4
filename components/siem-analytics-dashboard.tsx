                    ...
                    <Card className="bg-slate-800 border-slate-700">
                      <CardHeader className="pb-3">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger>
                              <div className="h-3 w-3 text-slate-400">ℹ️</div>
                            </TooltipTrigger>
                            <TooltipContent>
                              <p>Overall threat level based on multiple intelligence sources and ML analysis.</p>
                              <p className="mt-1">Incorporates geopolitical factors, cyber threat intelligence, and space domain awareness.</p>
                              <p className="mt-1">Range: 0-100%, where higher values indicate greater threat severity.</p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Coordinated threat operations currently targeting space assets and infrastructure.</p>
                                <p className="mt-1">Identified through pattern analysis, threat intelligence sharing, and ML-based correlation of disparate events.</p>
                                <p className="mt-1">Each campaign represents a distinct set of TTPs (Tactics, Techniques, and Procedures) linked to specific threat actors.</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Identified threat actors with known capabilities to target space assets.</p>
                                <p className="mt-1">Based on intelligence reports, historical activities, and attribution analysis.</p>
                                <p className="mt-1">Includes state-sponsored groups, non-state actors, and commercial entities with malicious intent.</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Indicators of Compromise (IoCs) detected in satellite communications and operations.</p>
                                <p className="mt-1">Includes unusual command patterns, unauthorized access attempts, and anomalous data transmissions.</p>
                                <p className="mt-1">Detected through ML-based pattern recognition and signature matching against known threat databases.</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </div>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>Breakdown of individual risk factors contributing to the overall threat level.</p>
                              <p className="mt-1">Each factor is scored independently based on real-time intelligence and ML analysis.</p>
                              <p className="mt-1">Range: 0-100%, with trend indicators showing recent changes in risk levels.</p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </div>
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <TooltipProvider>
                                    <Tooltip>
                                      ...
                                      <TooltipContent>
                                        {factor.name === "Geopolitical Tension" && (
                                          <p>Assessment of international relations and conflicts that could impact space operations.</p>
                                        )}
                                        {factor.name === "Solar Activity" && (
                                          <p>Measurement of solar flares, CMEs, and other solar events that could affect satellite operations.</p>
                                        )}
                                        {factor.name === "Cyber Threat Level" && (
                                          <p>Evaluation of cyber threats specifically targeting space systems and ground infrastructure.</p>
                                        )}
                                        {factor.name === "System Vulnerabilities" && (
                                          <p>Assessment of known technical vulnerabilities in satellite systems and supporting infrastructure.</p>
                                        )}
                                        <p className="mt-1">Score: {factor.score}% | Trend: {factor.trend}</p>
                                      </TooltipContent>
                                    </Tooltip>
                                  </TooltipProvider>
                                </div>
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>Identified threat actors with known capabilities to target space assets.</p>
                              <p className="mt-1">Based on intelligence reports, historical activities, and attribution analysis.</p>
                              <p className="mt-1">Actors are tracked and monitored for changes in tactics, techniques, and procedures.</p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </div>
