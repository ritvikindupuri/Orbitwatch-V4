                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Composite anomaly score from multiple ML models:</p>
                                <ul className="mt-1 list-disc pl-4">
                                  <li>Real-time telemetry analysis</li>
                                  <li>Behavioral pattern recognition</li>
                                  <li>Historical deviation measurement</li>
                                </ul>
                                <p className="mt-1">Range: 0-1, where values closer to 1 indicate higher confidence in anomaly detection.</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </div>
